...
test_main(void)
{
  ...
  test_aead(&nettle_ocb_aes128, NULL,
	    ...
	    SHEX("479AD363AC366B95A98CA5F3000B1479")); /* tag */
  ...
  test_aead_message(&ocb_aes128_message,
	    ...
	    SHEX("0001020304050607"), /* auth data */
	    SHEX(""), /* plaintext */
	    SHEX("81017F8203F081277152FADE694A0A00")); /* ciphertext */
  ...
  test_aead_message(&ocb_aes128_message,
	    ...
	    SHEX(""), /* auth data */
	    SHEX("0001020304050607"), /* plaintext */
	    SHEX("45DD69F8F5AAE724"
		 "14054CD1F35D82760B2CD00D2F99BFA9")); /* ciphertext */
  ...
  test_aead_message(&ocb_aes128_message,
	    ...
	    SHEX("000102030405060708090A0B0C0D0E0F"), /* auth data */
	    SHEX("000102030405060708090A0B0C0D0E0F"), /* plaintext */
	    SHEX("571D535B60B277188BE5147170A9A22C"
		 "3AD7A4FF3835B8C5701C1CCEC8FC3358")); /* ciphertext */
  ...
  test_aead_message(&ocb_aes128_message,
	    ...
	    SHEX("000102030405060708090A0B0C0D0E0F"), /* auth data */
	    SHEX(""), /* plaintext */
	    SHEX("8CF761B6902EF764462AD86498CA6B97")); /* ciphertext */
  ...
  test_aead_message(&ocb_aes128_message,
	    ...
	    SHEX(""), /* auth data */
	    SHEX("000102030405060708090A0B0C0D0E0F"), /* plaintext */
	    SHEX("5CE88EC2E0692706A915C00AEB8B2396"
		 "F40E1C743F52436BDF06D8FA1ECA343D")); /* ciphertext */
  ...
  test_aead_message(&ocb_aes128_message,
	    ...
	    SHEX("000102030405060708090A0B0C0D0E0F1011121314151617"), /* auth data */
	    SHEX("000102030405060708090A0B0C0D0E0F1011121314151617"), /* plaintext */
	    SHEX("1CA2207308C87C010756104D8840CE1952F09673A448A122"
		 "C92C62241051F57356D7F3C90BB0E07F")); /* ciphertext */
  ...
  test_aead_message(&ocb_aes128_message,
	    ...
	    SHEX("000102030405060708090A0B0C0D0E0F1011121314151617"), /* auth data */
	    SHEX(""), /* plaintext */
	    SHEX("6DC225A071FC1B9F7C69F93B0F1E10DE")); /* ciphertext */
  ...
  test_aead_message(&ocb_aes128_message,
	    ...
	    SHEX("221BD0DE7FA6FE993ECCD769460A0AF2D6CDED0C395B1C3C"
		 "E725F32494B9F914D85C0B1EB38357FF")); /* ciphertext */
  ...
  test_aead_message(&ocb_aes128_message,
	    ...
	    SHEX("BD6F6C496201C69296C11EFD138A467ABD3C707924B964DE"
		 "AFFC40319AF5A485"
		 "40FBBA186C5553C68AD9F592A79A4240")); /* ciphertext */
  ...
  test_aead_message(&ocb_aes128_message,
	    ...
	    SHEX("000102030405060708090A0B0C0D0E0F1011121314151617"
		 "18191A1B1C1D1E1F"), /* auth data */
	    SHEX(""), /* plaintext */
	    SHEX("FE80690BEE8A485D11F32965BC9D2A32")); /* ciphertext */
  ...
  test_aead_message(&ocb_aes128_message,
	    ...
	    SHEX("2942BFC773BDA23CABC6ACFD9BFD5835BD300F0973792EF4"
		 "6040C53F1432BCDF"
		 "B5E1DDE3BC18A5F840B52E653444D5DF")); /* ciphertext */
  ...
  test_aead_message(&ocb_aes128_message,
	    ...
	    SHEX("000102030405060708090A0B0C0D0E0F1011121314151617"
		 "18191A1B1C1D1E1F2021222324252627"), /* plaintext */
	    SHEX("D5CA91748410C1751FF8A2F618255B68A0A12E093FF45460"
		 "6E59F9C1D0DDC54B65E8628E568BAD7A"
		 "ED07BA06A4A69483A7035490C5769E60")); /* ciphertext */
  ...
  test_aead_message(&ocb_aes128_message,
	    ...
	    SHEX("000102030405060708090A0B0C0D0E0F1011121314151617"
		 "18191A1B1C1D1E1F2021222324252627"), /* auth data */
	    SHEX(""), /* plaintext */
	    SHEX("C5CD9D1850C141E358649994EE701B68")); /* ciphertext */
  ...
  test_aead_message(&ocb_aes128_message,
	    ...
	    SHEX("000102030405060708090A0B0C0D0E0F1011121314151617"
		 "18191A1B1C1D1E1F2021222324252627"), /* plaintext */
	    SHEX("4412923493C57D5DE0D700F753CCE0D1D2D95060122E9F15"
		 "A5DDBFC5787E50B5CC55EE507BCB084E"
		 "479AD363AC366B95A98CA5F3000B1479")); /* ciphertext */
